...
class Command(BaseCommand):
    help = "Sync executions (fills) from IBKR into the local Execution model."
    ...
    def handle(self, *args: Any, **options: Any) -> None:
        ...
        for ba in qs:
            self.stdout.write(f"Syncing executions for account {ba.account_code}...")
            summary = sync_executions_for_broker_account(ba)
        ...
        self.stdout.write(
            self.style.SUCCESS(
                f"Done. Total executions created={total_created}, "
